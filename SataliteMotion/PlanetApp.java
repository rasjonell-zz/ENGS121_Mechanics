 ...
 *
 * This program demonstrates: how to use the Simulation control to run and
 * single step a time dependent model.
 *
...
public class PlanetApp extends AbstractSimulation {
  ...
  public void doStep() {
    ...
    frame.setMessage("VX = " + planet.getState()[1]);
    frame.setMessage("VY = " + planet.getState()[3]);
    frame.setMessage("X = " + planet.getState()[0]);
    frame.setMessage("Y = " + planet.getState()[2]);
  }
  ...
  public void initialize() {
    ...
    double w = control.getDouble("w");
    // create an array on the fly as the argument to another method
    planet.initialize(new double[] { x, vx, y, vy, w, 0 });
